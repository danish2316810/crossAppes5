		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cross App",
									"targetURL": "#crosscrossapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"crosscrossapp-display": {
								"semanticObject": "crosscrossapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cross.crossapp",
									"url": sap.ui.require.toUrl("cross/crossapp")
								}
							}
						}
					}
